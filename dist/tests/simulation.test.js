...
import { createDefaultSessionState, playPaidSpinRound, spinCashCove } from "../engine/cashCove243.js";
import { createSeededRng, runSimulationBatch } from "../simulations/core.js";
...
test("paid round resolves trigger and all awarded free spins", () => {
    const state = createDefaultSessionState();
    const round = playPaidSpinRound(sequenceRng([
        0, 0, 0, 0, 0,
